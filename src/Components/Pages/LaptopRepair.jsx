...
const LaptopRepair = () => {
    ...
    const laptopServices = [
        ...
        { name: "OS Installation", image: `${os}`, icon: <svg className="h-10 w-10 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor"><rect x="4" y="4" width="16" height="16" rx="2" /><path d="M8 12h8" /></svg>, desc: "Install or upgrade operating systems.", price: "৳500 - ৳1,500" },
    ];
    ...
    return (
        <div className="min-h-screen bg-base-200">
            {/* Hero Section */}
            <div className="bg-gradient-to-r from-green-600 to-blue-600 text-white pt-24 pb-16">
                <div className="container mx-auto px-4 text-center">
                    <h1 className="text-4xl md:text-5xl font-bold mb-4">Laptop Repair Services</h1>
                    <p className="text-xl mb-8">Expert laptop repair with certified technicians and genuine parts</p>
            ...
            <div className="container mx-auto px-4 py-12">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-base-content mb-4">Professional Laptop Repair Services</h2>
                    <p className="text-base-content/70 max-w-2xl mx-auto">
                        From screen replacement to motherboard repair, we handle all laptop issues 
                        with precision and care using advanced diagnostic tools.
                    </p>
                </div>
